...
const Menu = () => {
    ...
    const getCocktailAt = (inedxOffset) => {
        return allCocktails[(currentIndex + inedxOffset + totalCocktails) % totalCocktails]
    }
  ...
  return (
    <section id='menu' aria-labelledby='menu-heading'>
        ...
        <div className="content">
            ...
            <div className="cocktail"><img src={currentCocktail.image} alt="" className="object-contain" /></div>
